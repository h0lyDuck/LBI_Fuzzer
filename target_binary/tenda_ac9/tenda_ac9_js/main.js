...
if(B.lang == "cn"){
    $("#main-nav").css("width","125px");
    $(".main-content").css("margin-left","135px");
}else if(B.lang == "zh"){
    $("#main-nav").css("width","125px");
    $(".main-content").css("margin-left","135px");
}else {
    $("#main-nav").css("width","155px");
}
...
var lanSelect = '<a class="lang-toggle" style="float: left"><span>中文</span><b style="border-top-color:#999" class="caret"></b></a><ul class="lang-menu none" style="top: 43px; z-index: 1000;">'+ G.langList+'</ul><span style="display: block;float: left;margin: 13px 6px">|</span>';
