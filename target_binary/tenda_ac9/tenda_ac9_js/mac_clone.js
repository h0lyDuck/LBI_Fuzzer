...
var moduleModel = R.moduleModel({
	...
	getSubmitData: function () {
		...
		if (top.CONFIG_PAGE_HAVE_SERV_NAME == "y" && G.wanType == "2") {
...
function changeServiceType() {
    if($("#serviceType").val() == "1"){    //自定义
        ...
        $("#serviceName-Text").html("Keep the default unless necessary");
    }
    top.initIframeHeight();
}
function changeServerType() {
    if($("#serverType").val() == "1"){      //自定义
        ...
        $("#serverName-Text").html("Keep the default unless necessary");
    }
    top.initIframeHeight();
}
...
function initValue(obj) {
	...
	//@edit by pjl
	if (top.CONFIG_PAGE_HAVE_SERV_NAME == "y" && obj.wanInfo[0].wanType == "2") {
